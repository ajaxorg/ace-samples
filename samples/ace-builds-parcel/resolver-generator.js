...
function buildResolver() {
    ...
    loader = loader + paths.map(function (path) {
        if (/\.js$/.test(path) && !/^ace\.js$/.test(path)) {
            ...
            return `ace.config.setModuleUrl('ace/${moduleName}', new URL("../node_modules/ace-builds/src-noconflict/${path}", import.meta.url))`;
        }
    }).join('\n');

    fs.writeFileSync(__dirname + '/generated/esm-resolver.js', loader, "utf8");
}
